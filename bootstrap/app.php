...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions) {
        ...
        // Keep the affiliate/MSOrg API machine-readable when an unexpected
        // Laravel exception occurs. Infrastructure errors generated by
        ...
        $exceptions->render(function (Throwable $exception, Request $request) {
            ...
            return response()->json([
                'Status' => 'failed',
                'apiresponse' => 'Service temporarily unavailable. Please try again shortly.',
                'api_response' => 'Service temporarily unavailable. Please try again shortly.',
            ], 503);
        });
    })->create();
