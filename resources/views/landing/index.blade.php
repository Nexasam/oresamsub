...
<head>
    ...
    <title>Crystalpay Data Website</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="top-nav" id="home">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <p> <i class='bx bxs-envelope'></i> info@crystalpay.com</p>
                    <p>  <a style="text-decoration: none; color:white" href="tel:08168509044"><i class='bx bxs-phone-call'></i>2348168509044</a> </p>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">CrystalPay<span class="dot">.</span></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center text-white">
                        <h6 class="text-white text-uppercase">Ready for quality?</h6>
                        <h1 class="display-3 my-4">We are committed<br />to giving you quality services</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-10 offset-lg-1 text-white">
                        <h6 class="text-white text-uppercase">Competitive prices</h6>
                        <h1 class="display-3 my-4">Our customers love us because <br />we give the best market prices</h1>
                        <a href="{{ url('/register') }}" class="btn btn-brand">Get Started</a>
                        <a href="{{ url('/login') }}" class="btn btn-outline-light ms-3">Login</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="intro">
                        <h6>about us</h6>
                        <h1>Who we are</h1>
                        <p class="mx-auto">Welcome to CrystalPay Solutions, your trusted partner in seamless and efficient bill payment services. Founded with a vision to simplify financial transactions, CrystalPay Solutions is dedicated to providing a convenient, secure, and user-friendly platform for managing all your bill payments in one place.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="milestone">
        <div class="container">
            <div class="row text-center justify-content-center gy-4">
                ...
                <div class="col-lg-2 col-sm-6">
                    <h1 class="display-4">12M+</h1>
                    <p class="mb-0">Referral bonuses</p>
                </div>
                <div class="col-lg-2 col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="intro">
                        <h6>Our Services</h6>
                        <h1>What We Do?</h1>
                        <p class="mx-auto">We specialize in selling data, airtime, bill payment services, cable TV subscriptions, e-pins, and much more.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
