        ...
        <div class="grid grid-cols-12 gap-1">
          ...
          <div class="col-span-12">
              ...
              <div class="box">
                ...
                <button class="hs-dropdown-toggle ti-btn ti-btn-success"  data-hs-overlay="#hs-vertically-centered-modal12">Add Announcement</button>
                             ...
                             @csrf
                              <div class="grid w-full lg:w-full lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                  <div class="grid grid-cols-1 gap-2">
                                      ...
                                      <div class="">
                                        <label class="ti-form-label mb-0">Description</label><div class="border rounded-md shadow-sm">
                                          <textarea name="description" id="ckeditor" rows="20" cols="20" class="editor"></textarea>
                                          {{-- <div class="bg-white min-h-[400px] p-3 editor"></div> --}}
                                        </div>     
                                      </div>
                                      ...
                                      <div class="">
                                          ...
                                          <input value="" name="position" type="number" class="my-auto ti-form-input" min="0" placeholder="position">
                                      </div>
                                     ...
                                     <div class="">
                                        ...
                                        <select id="status" name="status" required class="my-auto ti-form-select">
                                  ...
                                  <div class="space-y-2">
                                      <button type="submit" class="ti-btn ti-btn-primary w-full">Create Announcement</button>
                                  </div>
                            ...
                            <tbody>
                              ...
                              @foreach ($announcements as $ann)
                                  <tr>
                                                     ...
                                                     @csrf
                                                      <div class="grid w-full lg:w-full lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                                          <div class="grid grid-cols-1 gap-2">
                                                              <div class="">
                                                                  <label class="ti-form-label mb-0">Title</label>
                                                                  <input value="{{$ann->title}}" name="title" type="text" required class="my-auto ti-form-input" min="0" placeholder="title">
                                                              </div>
                        
                                                              <div class="">
                                                                <label class="ti-form-label mb-0">Description</label><div class="border rounded-md shadow-sm">
                                                                  <textarea name="description" rows="50" cols="50" class="editor">{!! $ann->description !!}</textarea>
                                                                  {{-- <div class="bg-white min-h-[400px] p-3 editor">{!! $ann->description !!}</div> --}}
                                                                </div>     
                                                              </div>      
                          
                                                              <div class="">
                                                                  <label class="ti-form-label mb-0">Position</label>
                                                                  <input value="{{$ann->position}}" name="position" type="number" class="my-auto ti-form-input" min="0" placeholder="position">
                                                              </div>
                                    ...
                                    <td>
                                      <span class="{{ $ann->status == 1 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }} px-2 py-1 rounded text-sm font-semibold">
