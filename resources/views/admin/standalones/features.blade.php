...
<div class="main-content">
    ...
    <div class="box"><div class="box-header"><h5 class="box-title">Add feature</h5></div><div class="box-body">
        <form method="POST" action="{{ route('admin.standalones.features.store') }}" class="grid grid-cols-12 gap-4">@csrf
            ...
            <div class="col-span-12 md:col-span-4"><label class="ti-form-label">Purchase mode</label><select class="ti-form-select" name="purchase_mode"><option value="single">Single purchase</option><option value="named_slots">Dynamic named slots</option></select></div>
    ...
    @foreach($features as $feature)<div class="box"><div class="box-header"><h5 class="box-title">{{ $feature->name }}</h5></div><div class="box-body">
        <form method="POST" action="{{ route('admin.standalones.features.update', $feature) }}" class="grid grid-cols-12 gap-4">@csrf @method('PUT')
            ...
            <div class="col-span-12 md:col-span-3"><label class="ti-form-label">Purchase mode</label><select class="ti-form-select" name="purchase_mode"><option value="single" @selected($feature->purchase_mode==='single')>Single purchase</option><option value="named_slots" @selected($feature->purchase_mode==='named_slots')>Dynamic named slots</option></select></div>
