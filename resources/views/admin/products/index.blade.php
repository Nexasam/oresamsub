          ...
          <div class="col-span-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h5 class="box-title">Main Products</h5>
                </div>
                ...
                <div class="box-body">
                  ...
                  <div class="mt-3">
                        ...
                        <table  class="ti-custom-table ti-custom-table-head ti-striped-table ti-custom-table-hover ">
                            ...
                            <tbody>
                              ...
                              @foreach ($products as $product)
                                  ...
                                  @php
                                      switch($product->first_downline_crediting_feature){
                                        case 1:
                                        $first_downline_crediting_feature = 'ON- FLAT RATE';
                                        break;

                                        case 2:
                                        $first_downline_crediting_feature = 'ON- PERCENTAGE RATE';
                                        break;

                                        case 3:
                                        $first_downline_crediting_feature = 'OFF';
                                        break;
                                                ...
                                                <div class="grid w-full lg:w-1/2 lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                                    ...
                                                    <div class="space-y-2">
                                                      ...
                                                      <select name="first_downline_crediting_feature" required class="my-auto ti-form-select">
                                                          ...
                                                          <option  @if ($product->first_downline_crediting_feature == 1) selected @endif value="1">Activate flat rate</option>
                                                          <option  @if ($product->first_downline_crediting_feature == 2) selected @endif value="2">Activate percentage rate</option>
                                                          <option  @if ($product->first_downline_crediting_feature == 3) selected @endif value="3">Deactivate both</option>
                                                    ...
                                                    <div class="space-y-2">
                                                      ...
                                                      <input value="{{ $product->set_first_downline_crediting_flat_rate }}" name="set_first_downline_crediting_flat_rate" type="number" required class="my-auto ti-form-input" min="0" placeholder="first crediting flat rate">
                                                     </div>
                                                     ...
                                                     <div class="space-y-2">
                                                      ...
                                                      <input value="{{ $product->set_first_downline_crediting_percentage_rate }}" name="set_first_downline_crediting_percentage_rate" type="number" required class="my-auto ti-form-input" min="0"  placeholder="first crediting percentage rate">
                                                    </div>
                                                
                
                                                    <div class="space-y-2">
                                                        <label class="ti-form-label mb-0">Set cap for first crediting commission <br>
                                                          <small>Upline cannot get more than this value if first crediting commission is percentage-based</small>
                                                        </label>
                                                        <input value="{{ $product->set_first_downline_crediting_cap }}" name="set_first_downline_crediting_cap" type="number" required class="my-auto ti-form-input" min="0"  placeholder="cap for first crediting">
                                                    </div>
                                                    <div class="space-y-2">
                                                        <button type="submit" class="ti-btn ti-btn-primary w-full">Update Product Details</button>
                                                    </div>
                    ...
                    <div id="pills-with-brand-color-3" class="hidden" role="tabpanel" aria-labelledby="pills-with-brand-color-item-3">
                      <p class="text-gray-500 dark:text-gray-500 p-5 border rounded-sm dark:border-white/10 border-gray-200">
