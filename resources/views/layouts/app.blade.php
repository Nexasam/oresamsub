...
<body class="montserrat2">
    ...
    <div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right" tabindex="-1">
      <div class="ti-offcanvas-header z-10 relative">
        ...
        <button type="button"
          class="ti-btn flex-shrink-0 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-gray-500 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-light-theme"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Light</label>
              </div>
              <div class="flex">
                <input type="radio" name="theme-style" class="ti-form-radio" id="switcher-dark-theme">
                <label for="switcher-dark-theme"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Dark</label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-ltr" class="text-xs text-gray-500 ms-2 dark:text-gray-500">LTR</label>
              </div>
              <div class="flex">
                <input type="radio" name="direction" class="ti-form-radio" id="switcher-rtl">
                <label for="switcher-rtl" class="text-xs text-gray-500 ms-2 dark:text-gray-500">RTL</label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-vertical"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Vertical</label>
              </div>
              <div class="flex">
                <input type="radio" name="navigation-style" class="ti-form-radio" id="switcher-horizontal">
                <label for="switcher-horizontal"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Horizontal</label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6 switcher-style">
              <div class="flex">
                <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-menu-click"
                  checked>
                <label for="switcher-menu-click" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Menu
                  Click</label>
              </div>
              <div class="flex">
                <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-menu-hover">
                <label for="switcher-menu-hover" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Menu
                  Hover</label>
              </div>
              <div class="flex">
                <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-icon-click">
                <label for="switcher-icon-click" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Icon
                  Click</label>
              </div>
              <div class="flex">
                <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-icon-hover">
                <label for="switcher-icon-hover" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Icon
                  Hover</label>
              </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-regular"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Regular</label>
              </div>
              <div class="flex">
                <input type="radio" name="data-page-styles" class="ti-form-radio" id="switcher-classic">
                <label for="switcher-classic"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Classic</label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-full-width"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">FullWidth</label>
              </div>
              <div class="flex">
                <input type="radio" name="layout-width" class="ti-form-radio" id="switcher-boxed">
                <label for="switcher-boxed" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Boxed</label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-menu-fixed"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Fixed</label>
              </div>
              <div class="flex">
                <input type="radio" name="data-menu-positions" class="ti-form-radio" id="switcher-menu-scroll">
                <label for="switcher-menu-scroll"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Scrollable </label>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-header-fixed" class="text-xs text-gray-500 ms-2 dark:text-gray-500">
                  Fixed</label>
              </div>
              <div class="flex">
                ...
                <label for="switcher-header-scroll"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500">Scrollable
                </label>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-2 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-default-menu"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500 ">Default
                  Menu</label>
              </div>
              <div class="flex">
                <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-closed-menu">
                <label for="switcher-closed-menu" class="text-xs text-gray-500 ms-2 dark:text-gray-500 ">
                  Closed
                  Menu</label>
              </div>
              <div class="flex">
                <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-icontext-menu">
                <label for="switcher-icontext-menu" class="text-xs text-gray-500 ms-2 dark:text-gray-500 ">Icon
                  Text</label>
              </div>
              <div class="flex">
                <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-icon-overlay">
                <label for="switcher-icon-overlay" class="text-xs text-gray-500 ms-2 dark:text-gray-500 ">Icon
                  Overlay</label>
              </div>
              <div class="flex">
                <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-detached">
                <label for="switcher-detached"
                  class="text-xs text-gray-500 ms-2 dark:text-gray-500 ">Detached</label>
              </div>
              <div class="flex">
                <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-double-menu">
                <label for="switcher-double-menu" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Double
                  Menu</label>
              </div>
            </div>
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 switcher-style">
              <div class="flex">
                ...
                <label for="switcher-loader-enable" class="text-xs text-gray-500 ms-2 dark:text-gray-500"> Enable</label>
              </div>
              <div class="flex">
                <input type="radio" name="page-loader" class="ti-form-radio" id="switcher-loader-disable">
                <label for="switcher-loader-disable" class="text-xs text-gray-500 ms-2 dark:text-gray-500">Disable</label>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="page">
                  ...
                  <div class="relative">
                    ...
                    <div class="search-dropdown hs-dropdown ti-dropdown">
                      <button type="button" aria-label="button"
                        class="hs-dropdown-toggle ti-dropdown-toggle text-gray-500 dark:!bg-transparent dark:text-gray-500 p-0 !border-0 shadow-none">
        ...
        <footer class="mt-auto py-3 border-t dark:border-white/10 bg-white dark:bg-bgdark">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-center">Copyright © <span id="year"></span> <a href="https://api.whatsapp.com/send?phone={{  '2347073459839'  }}&text=Hello,%20Please%20I%20want%20to%20own%20a%20data%20website" class="text-primary">Developed with ❤️ by Subutility</a> All rights reserved </p>
              </div>
        </footer>
