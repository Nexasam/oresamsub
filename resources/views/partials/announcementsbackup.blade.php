...
>
    <div 
        class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md relative overflow-y-auto max-h-[90vh]"
        @click.stop 
    >
        <button @click="open = false" class="absolute top-2 right-2 text-gray-900 hover:text-red-500 text-xl font-bold">
            &times;
        ...
        <h2 class="text-xl font-bold text-gray-800 mb-2">🎉 {{__('messages.Announcements')}}!</h2>
