<div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-5 items-center px-2 md:px-0 py-6 gap-4 md:gap-3 text-[12px] ">
    <div class="md:flex items-center p-2 md:p-3 rounded-lg border border-gray-300 space-x-1 md:space-x-4">
   ...
   <div class="md:flex items-center p-2 md:p-3 rounded-lg border border-gray-300 space-x-1 md:space-x-4">
    ...
    @foreach ($user_virtual_accounts as $user_virtual_account)
        <div class="w-full flex-col text-[10px]  rounded-lg border border-gray-300">
            ...
            <div class="p-2 md:pt-3">
                <p>
                <span class="font-bold mb-2" id="textToCopy">{{ $user_virtual_account->account_number }} </span>
                {{ $user_virtual_account->account_name }} -  {{ $user_virtual_account->bank_name }}
                </p>
