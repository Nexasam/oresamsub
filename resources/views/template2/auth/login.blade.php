    ...
    <div class="bg-white rounded-xl px-2 py-4  mt-2">
        ...
        <form method="POST" action="{{ route('login') }}" class="md:max-w-xl mx-auto space-y-6 pb-4 px-4"> 
            ...
            <div>
                ...
                <div class="relative">
                <!-- dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[{{$site_primary_color}}] dark:focus:border-[{{$site_primary_color}}] -->
                <input d="password" required type="password" name="password" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[{{$site_primary_color}}] focus:border-[{{$site_primary_color}}] block w-full p-2.5  " placeholder="**********" >
