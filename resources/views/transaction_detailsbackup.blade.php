...
@section('content')
      ...
      <div class="main-content">
        ...
        <div class="block justify-between page-header md:flex">
            <div>
                <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> Transaction details with ID:  <strong>{{ 'transaction details' }}</strong></h3>
            </div>
                           ...
                           <div class="space-y-2">
                            ...
                            {{-- <div class="space-y-2">
                                ...
                                <ul class="flex flex-col sm:flex-row">
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 sm:-ms-px sm:mt-0 sm:first:rounded-se-none  sm:first:rounded-es-sm sm:last:rounded-es-none  sm:last:rounded-se-sm dark:bg-bgdark dark:border-white/10 dark:text-white">
                                      <div class="relative flex items-start w-full">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-1" class="ms-3 block w-full text-sm text-gray-600 dark:text-gray-500">
                                         Female
                                        </label>
                                      </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 sm:-ms-px sm:mt-0 sm:first:rounded-se-none  sm:first:rounded-es-sm sm:last:rounded-es-none  sm:last:rounded-se-sm dark:bg-bgdark dark:border-white/10 dark:text-white">
                                      <div class="relative flex items-start w-full">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-2" class="ms-3 block w-full text-sm text-gray-600 dark:text-gray-500">
                                          Male
                                        </label>
                                      </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 sm:-ms-px sm:mt-0 sm:first:rounded-se-none  sm:first:rounded-es-sm sm:last:rounded-es-none  sm:last:rounded-se-sm dark:bg-bgdark dark:border-white/10 dark:text-white">
                                      <div class="relative flex items-start w-full">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-3" class="ms-3 block w-full text-sm text-gray-600 dark:text-gray-500">
                                        Others
                                        </label>
                                      </div>
                                    </li>
                      ...
                      <div class="grid grid-cols-12">
                          <div class="col-span-12 xl:col-span-6 xl:border-e xl:border-b-0 border-b p-6 border-gray-200 dark:border-white/10">
                            <div class="space-y-4">
                              ...
                              <p class="text-xs text-gray-500 dark:text-gray-500">Password should be min of <b class="text-success">10 characters <sup>*</sup> </b> (and up to 100 characters),<b class="text-success">One Upper Case Character<sup>*</sup></b> and <b class="text-success">One Special Character<sup>*</sup></b>   e.g., ! @ # ? included.</p>
                            </div>
                          </div>
                                  ...
                                  <ul class="flex flex-col">
                                        ...
                                        <div class="sm:flex w-full space-y-2">
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                            <div class="avatar rounded-sm avatar-sm bg-gray-100 dark:bg-bodybg p-2.5">
                                              <i class="ri ri-smartphone-line text-xl leading-none text-gray-500 dark:text-gray-500"></i>
                                            </div>
                                            <div class="">
                                              <p class="mb-0 text-sm">Mobile-Poco-M2-Pro</p>
                                              <p class="mb-0 text-gray-500 dark:text-gray-500 text-xs">Manchester, UK-Nov 30, 04:45PM</p>
                                            </div>
                                          </div>
                                      ...
                                      <li class="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                                        <div class="sm:flex w-full space-y-2">
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                            <div class="avatar rounded-sm avatar-sm bg-gray-100 dark:bg-bodybg p-2.5">
                                              <i class="ri ri-tablet-line text-xl leading-none text-gray-500 dark:text-gray-500"></i>
                                            </div>
                                            <div class="">
                                              <p class="mb-0 text-sm">Apple Tablet</p>
                                              <p class="mb-0 text-gray-500 dark:text-gray-500 text-xs">Manchester, UK-Nov 30, 02:45PM</p>
                                            </div>
                                          </div>
                                          <div class="ms-auto my-auto text-end">
                                            <button type="button" class="px-2 py-1 ti-btn ti-btn-soft-info text-xs">ReWoke</button>
                                      ...
                                      <li class="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                                        <div class="sm:flex w-full space-y-2">
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                            <div class="avatar rounded-sm avatar-sm bg-gray-100 dark:bg-bodybg p-2.5">
                                              <i class="ri ri-airplay-line text-xl leading-none text-gray-500 dark:text-gray-500"></i>
                                            </div>
                                            <div class="">
                                      ...
                                      <li class="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                                        <div class="sm:flex w-full space-y-2">
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                            <div class="avatar rounded-sm avatar-sm bg-gray-100 dark:bg-bodybg p-2.5">
                                              <i class="ri ri-macbook-line text-xl leading-none text-gray-500 dark:text-gray-500"></i>
                                            </div>
                                            <div class="">
                        ...
                        <div class="p-4 border border-gray-200 dark:border-white/10 rounded-sm">
                          <div class="md:grid grid-cols-12 gap-6 space-y-4">
                            <div class="col-span-12 md:col-span-6 my-auto">
                              ...
                              <p class="text-xs mb-0 text-gray-500 dark:text-gray-500">The Comment Notifications are the notifications you get for your posts and replies for your comments.</p>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                              <div class="space-y-2">
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Notify Me</label>
                                  </div>
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Notify Me If Mentioned</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Notify For My Posts</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5" checked>
                                  </div>
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">All Comments</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5">
                                  </div>
                        ...
                        <div class="p-4 border border-gray-200 dark:border-white/10 rounded-sm">
                          <div class="md:grid grid-cols-12 gap-6 space-y-4">
                            <div class="col-span-12 md:col-span-6 my-auto">
                              ...
                              <p class="text-xs mb-0 text-gray-500 dark:text-gray-500">The Tag Notifications are the notifications you get when you are tagged for others posts.</p>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                        ...
                        <div class="p-4 border border-gray-200 dark:border-white/10 rounded-sm">
                          <div class="md:grid grid-cols-12 gap-6 space-y-4">
                            <div class="col-span-12 md:col-span-6 my-auto">
                              ...
                              <p class="text-xs mb-0 text-gray-500 dark:text-gray-500">The Reminder Notifications are the notifications you get when you missed any update .</p>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                              <div class="space-y-2">
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Remind Me</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5" checked>
                                  </div>
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Remind Me only Important Updates</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5" checked>
                                  </div>
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Remind Me All updates</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5">
                                  </div>
                        ...
                        <div class="p-4 border border-gray-200 dark:border-white/10 rounded-sm">
                          <div class="md:grid grid-cols-12 gap-6 space-y-4">
                            <div class="col-span-12 md:col-span-6 my-auto">
                              ...
                              <p class="text-xs mb-0 text-gray-500 dark:text-gray-500">The Notifications is for likes ,comments,reactions for your profile  .</p>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                              <div class="space-y-2">
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Notify Me only Important</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5">
                                  </div>
                                ...
                                <div class="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div class="col-span-9 my-auto">
                                    <label class="text-sm text-gray-500 ms-3 dark:text-gray-500">Notify Me All</label>
                                  </div>
                                  <div class="col-span-3 my-auto">
                                    <input type="checkbox" class="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5" checked>
                                  </div>
