                                        ...
                                        <form method="POST" action="{{ route('user.wallets.verify_monnify_account_via_bvn') }}">
                                            ...
                                            <div class="grid w-full lg:w-1/2 lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                                ...
                                                <div class="space-y-2">
                                                  ...
                                                  <input type="number" class="my-auto ti-form-input" id="bvn" name="bvn" value="" placeholder="Enter BVN to verify">
                                                </div>

                                                <div class="space-y-2">
                                                    <label class="ti-form-label mb-0">Account Number:</label>
                                                    <input type="number" class="my-auto ti-form-input" id="account_number" name="account_number" value="" placeholder="Account number">   
                                                </div>
