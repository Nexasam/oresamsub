...
@section('content')
      ...
      <div class="main-content">
        ...
        <div class="block justify-between page-header md:flex">
            {{-- <div>
                <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> Buy  <strong>{{ $plan_category->product_plan_category_name }}</strong> </h3>
            </div>
