...
<body class="authentication-page !h-full">
        ...
        <canvas class="error-basic-background"></canvas>
            <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-3 text-2xl font-bold text-gray-800 dark:text-white">Oops, Session Expired.</p>
                <p class="text-gray-600 dark:text-gray-500">Sorry, it appears like your session expired. Please use the button below to clear session.</p>
