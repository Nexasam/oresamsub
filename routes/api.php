...
use App\Http\Controllers\Api\v1\Standalone\FeatureController as StandaloneFeatureController;
...
Route::prefix('v1/standalone')->middleware(['standalone.auth', 'throttle:30,1'])->group(function () {
    ...
    Route::middleware('standalone.operational')->group(function () {
        ...
        Route::get('features', [StandaloneFeatureController::class, 'index']);
        Route::get('features/purchases', [StandaloneFeatureController::class, 'purchases']);
        Route::get('features/{feature}', [StandaloneFeatureController::class, 'show']);
        Route::post('features/{feature}/purchase', [StandaloneFeatureController::class, 'purchase'])->middleware('throttle:30,1');
        Route::post('features/{feature}/cancel', [StandaloneFeatureController::class, 'cancel'])->middleware('throttle:30,1');
    });
});
// use App\Http\Controllers\ExternalIntegration\ApiIntegrationController;
// use App\Http\Controllers\ExternalIntegration\Products\ProductsController;
