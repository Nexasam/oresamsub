...
Route::middleware(['set_locale'])->group(function () {
            ...
            Route::middleware(['auth','verified','admin'])->prefix('admin/automation-funding')->name('admin.automation-funding.')->group(function () {
                ...
                Route::post('/refresh-merchant-balance', [AutomationWalletFundingController::class, 'refreshMerchantBalance'])->name('refresh-merchant-balance');
                ...
                Route::post('/{funding}/save-bank-info', [AutomationWalletFundingController::class, 'saveBankInfo'])->name('save-bank-info');
            ...
            // admin.automation-product-plans.store

            Route::middleware(['auth','verified','admin'])->post('/admin/automation-product-plans', [AutomationProductPlanController::class, 'store'])
            ...
            Route::middleware(['auth','verified','admin'])->post('admin/product-plans/update_plan2', [ProductPlanController::class, 'update_plan2'])->name('admin.product_plans.update_plan2');
            Route::middleware(['auth','verified','admin'])->put('admin/product-plans-new/{id}', [ProductPlanController::class, 'update_product_plan_new'])->name('admin.product_plans.update_product_plan_new');
