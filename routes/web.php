...
Route::middleware(['set_locale'])->group(function () {
            ...
            Route::middleware(['auth','verified','admin'])->get('admin/unique_product_plans/fetch', [UniqueProductPlansController::class, 'admin_fetch_unique_product_plans'])->name('admin.unique_product_plans.admin_fetch_unique_product_plans');
